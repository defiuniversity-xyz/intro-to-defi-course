...
### Header Image
**Concept:** Wallet connecting to DeFi interface like key fitting into lock, showing "read-only access" granted
**Style:** Secure connection visual
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Connection vs. Approval vs. Transaction"
**Content:** Three levels: Connection (eyes/view), Approval (key/permission), Transaction (action/execution). Risk increases down.
**Style:** Escalating access levels

### Analogy Illustration
**Concept:** Passwordless login via wallet signature
**Style:** Authentication flow comparison

### Audio Notes
- Make connection vs. approval vs. transaction very clear
- Emphasize connection is relatively low risk
- URL verification before connection is critical
- Duration target: 4 minutes

### Video Concept
- Screen recording style showing connection process
- What to look for in wallet prompts
