...
**Core concept:** DeFi (Decentralized Finance) is a system of financial services—like borrowing, lending, and trading—that operates on blockchain without traditional banks or intermediaries.
...
|-------------|-----------------|
| Stock exchange | Decentralized exchange (DEX) |
| Bank savings account | Lending protocol |
| Bank loan | Collateralized borrowing |
| Insurance | DeFi insurance protocols |
| Investment funds | Yield aggregators, DAOs |
...
![Summary](https://storage.googleapis.com/intro-to-defi-media/images/lesson_01/intro-to-defi_01_summary.png)
...
### Header Image
**Concept:** Traditional bank building transforming into network of connected smart contracts/nodes
**Style:** Physical to digital transformation
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Traditional vs DeFi"
**Content:** Side-by-side comparison: Bank (building, people, applications) vs. DeFi (code, blockchain, instant access)
**Style:** Comparison columns

### Analogy Illustration
**Concept:** Vending machine dispensing financial services (loans, trades, interest)
**Style:** Futuristic vending machine concept

### Audio Notes
- Vending machine analogy sets the foundation
- Cover the "what you can do" list to make it concrete
- Balance excitement with risk awareness
- Duration target: 4-5 minutes

### Video Concept
- Animation of traditional bank process vs. DeFi process
- Show same service (loan) through both systems
- Highlight speed and accessibility differences
