...
### Header Image
**Concept:** New restaurant (exciting, risky) vs. chain restaurant (boring, safe)—DeFi choice
**Style:** Risk/reward visualization
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "DeFi Risk Categories"
**Content:** Risk types in categories: Smart contract, Liquidation, Impermanent loss, Oracle, Rug pull, User error. Mitigation for each.
**Style:** Risk matrix with mitigations

### Analogy Illustration
**Concept:** New restaurant vs. chain—excitement/risk tradeoff
**Style:** Dining choice comparison

### Audio Notes
- Be honest about risks—not fear-mongering, but realistic
- Give specific examples with numbers
- Focus on mitigations for each risk
- Duration target: 5 minutes

### Video Concept
- Each risk type explained with scenario
