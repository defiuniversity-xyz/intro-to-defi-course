...
**DeFi's answer:**
Anyone with a smartphone and internet can access:
...
![Summary](https://storage.googleapis.com/intro-to-defi-media/images/lesson_04/intro-to-defi_04_summary.png)
...
### Header Image
**Concept:** Person on phone at night with globe showing 24/7 access, while traditional bank building shows "CLOSED" sign
**Style:** Access contrast
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Problems DeFi Solves"
**Content:** Four quadrants: Access (24/7), Inclusion (unbanked), Trust (verify not trust), Efficiency (speed, cost). Brief problem → solution in each.
**Style:** Problem-solution format

### Analogy Illustration
**Concept:** Sunday night financial emergency—traditional vs. DeFi response
**Style:** Split scenario comparison

### Audio Notes
- Tell the Sunday night story vividly
- Use specific examples (Cyprus, Venezuela)
- Be balanced about what DeFi doesn't solve
- Duration target: 4-5 minutes

### Video Concept
- Real-world scenarios where DeFi helps
- Timeline comparisons (traditional vs. DeFi for same task)
- Global map showing accessibility
- Duration: 3 minutes
